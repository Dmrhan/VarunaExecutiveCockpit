...
export const generateMockData = (count: number = 451): { deals: Deal[], activities: Activity[], quotes: any[], orders: any[], contracts: Contract[] } => {
    ...
    for (let i = 0; i < count; i++) {
        ...
        const deal: Deal = {
            ...
            currency: 'TRY',
            dealType: ['opportunities.charts.dealTypes.newSale', 'opportunities.charts.dealTypes.renovation', 'opportunities.charts.dealTypes.crossSelling', 'opportunities.charts.dealTypes.upSellSale'][Math.floor(Math.random() * 4)],
    ...
    storyDeals.push({
        ...
        currency: 'TRY',
        dealType: 'opportunities.charts.dealTypes.newSale',
    ...
    storyDeals.push({
        ...
        currency: 'TRY',
        dealType: 'opportunities.charts.dealTypes.crossSelling',
    ...
    storyDeals.push({
        ...
        lastActivityDate: new Date().toISOString(),
        currency: 'TRY',
        dealType: 'opportunities.charts.dealTypes.upSellSale',
