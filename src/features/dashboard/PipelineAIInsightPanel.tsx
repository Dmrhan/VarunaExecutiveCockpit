...
export function PipelineAIInsightPanel({ currentDeals, allDeals, dateFilter, customRange, className }: PipelineAIInsightPanelProps) {
    ...
    return (
        <Card className={cn(
            ...
            <CardContent className="relative z-10 px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-white/90 font-light leading-snug line-clamp-2">
                        {insights.narrative}
                    </p>
                </div>
                ...
                <div className="flex items-center gap-3 flex-shrink-0 flex-wrap">
                    <div className="flex items-center gap-2 bg-white/10 px-3 py-2 rounded-xl border border-white/10 backdrop-blur-md">
                        {insights.revChange >= 0 ? <TrendingUp size={13} className="text-emerald-400" /> : <TrendingDown size={13} className="text-rose-400" />}
                    ...
                    {insights.stalledCount > 0 && (
                        <div className="flex items-center gap-2 bg-rose-500/20 px-3 py-2 rounded-xl border border-rose-500/20 backdrop-blur-md">
