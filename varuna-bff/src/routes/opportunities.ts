...
router.get('/', (req: Request, res: Response) => {
    ...
    const mapped = rows.map(row => ({
        ...
        topic: row.Name || '',
        created_at: row.FirstCreatedDate || row._SyncedAt,
        createdAt: row.FirstCreatedDate || row._SyncedAt,
        expected_close_date: row.CloseDate || row._SyncedAt,
        expectedCloseDate: row.CloseDate || row._SyncedAt,
        last_activity_date: row.FirstCreatedDate || row._SyncedAt,
        lastActivityDate: row.FirstCreatedDate || row._SyncedAt,
